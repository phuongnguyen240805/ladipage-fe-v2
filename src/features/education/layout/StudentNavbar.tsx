...
import { StudentNavGroups } from "@/features/education/constants/student_navigation";
...
export default function StudentSidebar() {
  ...
  const isActivePath = (path: string) =>
    pathname === path || (path !== "/education/dashboard/student" && pathname.startsWith(`${path}/`));
  ...
  return (
    ...
    >
      ...
      <div className="h-[80px] border-b border-gray-100 flex items-center justify-center px-4 overflow-hidden dark:border-slate-800 flex-shrink-0">
        <Link href="/education/dashboard/student/notifications" className="relative flex items-center justify-center w-full h-full">
          {isOpen ? (
            <div className="relative w-[310px] h-[88px] transition-all duration-300 flex items-center justify-center">
              <Image
                src="/education/images/logo/logo-sidebar-admin-big.png" // Dùng chung logo lớn sắc nét của bạn
                alt="Đại Học Đông Á"
                fill
                priority
                sizes="310px"
            ...
            <div className="relative w-9 h-9 transition-all duration-300">
              <Image
                src="/education/images/logo/logo-sidebar-admin-small.png" // Dùng chung logo icon khi thu nhỏ
                alt="UDA"
                fill
                priority
                sizes="36px"
