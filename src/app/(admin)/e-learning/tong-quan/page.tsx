      ...
      <div className="grid grid-cols-12 gap-6 w-full">
        ...
        <div className="col-span-12 lg:col-span-4 bg-white rounded-2xl p-6 shadow-[0_2px_12px_rgba(11,22,44,0.03)] border border-gray-100 w-full">
          ...
          <div className="grid grid-cols-4 gap-4 w-full">
            {[
              { label: "Thêm sinh viên", icon: <UserPlus className="h-5 w-5 text-emerald-600" />, href: "/e-learning/sinh-vien" },
              { label: "Thêm GV", icon: <UserPlus className="h-5 w-5 text-emerald-600" />, href: "/e-learning/giang-vien" },
              { label: "Thời khóa biểu", icon: <PlusCircle className="h-5 w-5 text-emerald-600" />, href: "/e-learning/thoi-khoa-bieu" },
              { label: "Quản lý môn", icon: <BookOpen className="h-5 w-5 text-emerald-600" />, href: "/e-learning/khoa-hoc" },
              { label: "Báo cáo", icon: <BarChart3 className="h-5 w-5 text-emerald-600" />, href: "/e-learning/bao-cao" },
              { label: "Cài đặt", icon: <Settings className="h-5 w-5 text-emerald-600" />, href: "/e-learning/thiet-lap" },
            ].map((item, idx) => (
