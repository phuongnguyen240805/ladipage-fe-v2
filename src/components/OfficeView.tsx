...
export default function OfficeView({
  ...
  return (
    <div className="h-full min-w-0 w-full overflow-hidden" style={{ minHeight: "100%" }}>
      <div className="relative mx-auto h-full min-w-0 w-full overflow-hidden">
        <div
          ref={containerRef}
          className="mx-auto h-full w-full min-w-0 overflow-hidden"
