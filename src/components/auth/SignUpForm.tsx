        ...
        <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button
                type="button"
                onClick={() => alert("Đăng ký Google hiện đang được cấu hình.")}
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-5">
                ...
                {/* <!-- Button --> */}
                <div>
                  <Button className="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-medium" size="sm" type="submit" disabled={isLoading}>
                    {isLoading && (
