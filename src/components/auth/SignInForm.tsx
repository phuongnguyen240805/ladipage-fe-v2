...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!supabase) {
        // Fallback mock login for development without Supabase keys
        ...
        <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button
                type="button"
                onClick={() => alert("Đăng nhập Google hiện tại đang được cấu hình.")}
              ...
              <button
                type="button"
                onClick={() => alert("Đăng nhập X hiện tại đang được cấu hình.")}
                className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 cursor-pointer"
              >
                <svg
                  width="21"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-sm text-lime-600 hover:text-brand-600 dark:text-lime-500"
                  >
                    Quên mật khẩu?
                  </Link>
                </div>
                <div>
                  <Button className="w-full flex items-center justify-center gap-2" size="sm" type="submit" disabled={isLoading}>
                    {isLoading && (
