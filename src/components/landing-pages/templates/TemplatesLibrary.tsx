  ...
  return (
    <div className="landing-product-library mx-auto flex w-full max-w-[1320px] flex-col gap-5">
      <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 dark:border-slate-800 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-950 dark:text-white">Kho Template</h1>
        ...
        <div className="flex items-center gap-3">
          <button className="inline-flex h-10 items-center gap-2 rounded-lg border border-slate-300 bg-white px-4 text-sm font-bold text-slate-800 shadow-sm transition hover:border-slate-400 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
        ...
        <div className="flex flex-col gap-4 border-t border-slate-100 pt-4 dark:border-slate-800 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-slate-100 px-3 py-2 text-xs font-bold text-slate-700 ring-1 ring-slate-200 dark:bg-slate-900 dark:text-slate-300 dark:ring-slate-800">
              ...
              <span className="rounded bg-slate-950 px-1.5 py-0.5 text-ui-nano font-black text-white">ƯU ĐÃI</span>
            </div>
          </div>
        </div>
      </div>
              ...
              >
                <div className="relative aspect-[4/3.35] overflow-hidden bg-slate-100 dark:bg-slate-900">
                  ...
                  <div className="absolute left-3 top-3 flex items-center gap-2">
                    ...
                    <span className="rounded-md bg-white/90 px-2 py-1 text-ui-micro font-black text-slate-600 shadow-sm backdrop-blur dark:bg-slate-950/80 dark:text-slate-300">
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3 text-ui-caption font-bold text-slate-400 dark:border-slate-800">
