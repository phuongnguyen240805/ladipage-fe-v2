...
export default function UserMetaCard() {
  ...
  useEffect(() => {
    ...
    const meta = resolveProfileFromAccount(profile);
    setFirstName(first);
    setLastName(last);
  ...
  const handleSave = async () => {
    ...
    try {
      await updateProfile(
        buildProfileUpdatePayload({
          nickname: joinDisplayName(firstName, lastName),
          email,
          phone,
          bio,
          social,
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              {profileMeta.social.facebook ? (
                <a
                  target="_blank"
                  rel="noreferrer"
                  href={profileMeta.social.facebook}
              ...
              {profileMeta.social.x ? (
                <a href={profileMeta.social.x} target="_blank" rel="noreferrer" className={SOCIAL_ICON_CLASS}>
                  <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {profileMeta.social.linkedin ? (
                <a href={profileMeta.social.linkedin} target="_blank" rel="noreferrer" className={SOCIAL_ICON_CLASS}>
                  <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {profileMeta.social.instagram ? (
                <a href={profileMeta.social.instagram} target="_blank" rel="noreferrer" className={SOCIAL_ICON_CLASS}>
                  <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      value={social.x}
                      onChange={(e) => setSocial((prev) => ({ ...prev, x: e.target.value }))}
                    />
                  </div>
