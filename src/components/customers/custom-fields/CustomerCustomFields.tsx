          ...
          {/* Data Type Filter Dropdown */}
            <CustomSelect
              ...
              options={[
                ...
                { value: "Chữ", label: "Chữ (Text)" },
                { value: "Số", label: "Số (Number)" },
                { value: "Ngày tháng", label: "Ngày tháng (Date)" },
                { value: "Danh sách", label: "Danh sách (List)" },
                { value: "Đúng/Sai", label: "Đúng/Sai (Boolean)" },
              ]}
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-zoom-in">
              ...
              <form onSubmit={handleCreateField} className="p-6 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <CustomSelect
                    value={newDataType}
                    onChange={(val) => setNewDataType(val as any)}
                    options={[
                      { value: "Chữ", label: "Chữ (Text)" },
                      { value: "Số", label: "Số (Number)" },
                      { value: "Ngày tháng", label: "Ngày tháng (Date)" },
